 ...
 * path remains in charge of palette and picking previews; the world path only
 * supplies the projected quad and lets FilmEffects draw the filtered snapshot.
 */
public class FilterBoardFormRenderer extends BillboardFormRenderer<FilterBoardForm>
{
    ...
    {
        /* Picking needs an ordinary Target-aware shader so the form editor can
         * identify the lens. A non-world preview has no scene framebuffer to
         * sample, so it uses the familiar masked billboard preview instead. */
