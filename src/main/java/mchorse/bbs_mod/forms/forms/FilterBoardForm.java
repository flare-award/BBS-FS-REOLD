...
public class FilterBoardForm extends BillboardForm
{
    ...
    public final ValueGroup hsl = new ValueGroup("hsl");
    public final ValueGroup[] hslColors = new ValueGroup[BBSSettings.HSL_COLOR_COUNT];
    public final ValueFloat[] hslHue = new ValueFloat[BBSSettings.HSL_COLOR_COUNT];
    public final ValueFloat[] hslSaturation = new ValueFloat[BBSSettings.HSL_COLOR_COUNT];
    public final ValueFloat[] hslLightness = new ValueFloat[BBSSettings.HSL_COLOR_COUNT];
    ...
    public FilterBoardForm()
    {
        ...
        {
            ValueGroup color = new ValueGroup(BBSSettings.HSL_COLOR_IDS[i]);

            this.hslColors[i] = color;
            this.hslHue[i] = new ValueFloat("hue", 0F, -180F, 180F);
            this.hslSaturation[i] = new ValueFloat("saturation", 0F, -1F, 1F);
            this.hslLightness[i] = new ValueFloat("lightness", 0F, -1F, 1F);

            color.add(this.hslHue[i]);
            color.add(this.hslSaturation[i]);
            color.add(this.hslLightness[i]);
            this.hsl.add(color);
        }

        this.filters.add(this.hsl);
