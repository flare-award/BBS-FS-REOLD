...
public class FilterClip extends CameraClip
{
    ...
    public static final List<String> CHANNEL_IDS = createChannelIds();

    public final ValueChannels channels = new ValueChannels("channels");

    public static String getHslChannelId(int color, String component)
    {
        return "hsl_" + BBSSettings.HSL_COLOR_IDS[color] + "_" + component;
    }

    private static List<String> createChannelIds()
    {
        ...
        {
            ids.add(getHslChannelId(i, "hue"));
            ids.add(getHslChannelId(i, "saturation"));
            ids.add(getHslChannelId(i, "lightness"));
        }
